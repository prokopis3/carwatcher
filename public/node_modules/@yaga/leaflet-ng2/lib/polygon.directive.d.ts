...
import { Event, FillRule, LatLng, LatLngExpression, LatLngTuple, LineCapShape, LineJoinShape, PathOptions, Polygon, PolylineOptions, PopupEvent, TooltipEvent } from 'leaflet';
import { MapComponent } from './map.component';
import { GenericGeoJSONFeature } from '@yaga/generic-geojson';
import { PopupDirective } from './popup.directive';
import { TooltipDirective } from './tooltip.directive';
export declare class PolygonDirective<T> extends Polygon implements OnDestroy, AfterViewInit {
