...
describe('Map Component', function () {
    ...
    describe('[(zoom)]', function () {
        it('should be changed in Leaflet when changing in Angular', function () {
            var val = Math.ceil(Math.random() * 15);
            map.zoom = val;
    ...
    describe('[(maxBounds)]', function () {
        ...
        it('should be changed in Leaflet when changing in Angular', function () {
            var lat1 = Math.random() * 100;
            var lat2 = Math.random() * 100;
            var lng1 = Math.random() * 100;
            var lng2 = Math.random() * 100;
            var val = leaflet_1.latLngBounds(leaflet_1.latLng(lat1 < lat2 ? lat1 : lat2, lng1 < lng2 ? lng1 : lng2), leaflet_1.latLng(lat1 < lat2 ? lat2 : lat1, lng1 < lng2 ? lng2 : lng1));
