...
import { Event, FillRule, LatLng, LatLngBounds, LatLngBoundsLiteral, LatLngExpression, LatLngTuple, LineCapShape, LineJoinShape, PathOptions, PolylineOptions, PopupEvent, Rectangle, TooltipEvent } from 'leaflet';
