...
describe('Polyline Directive', function () {
    ...
    beforeEach(function () {
        ...
        layer = new index_1.PolylineDirective(map);
    });
    ...
    describe('[properties]', function () {
        ...
        beforeEach(function () {
            layerWithPropertiesInterface = new index_1.PolylineDirective(map);
        });
        it('should be changed in Leaflet when changing in Angular', function () {
    ...
    describe('Popup in Polyline Directive', function () {
        ...
        before(function () {
            ...
            layerWithPopup = Object.create(new index_1.PolylineDirective(map), { popupDirective: { value: popup } });
    ...
    describe('Tooltip in Polyline Directive', function () {
        ...
        before(function () {
            ...
            // Hack to get write-access to readonly property
            layerWithTooltip = Object.create(new index_1.PolylineDirective(map), { tooltipDirective: { value: tooltip } });
