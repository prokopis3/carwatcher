    ...
    MarkerDirective.prototype.ngAfterContentInit = function () {
        ...
        if (this.iconDirective) {
            ...
            this.iconDirective.updateEvent.subscribe(function (event) {
                _this.setIcon(event.target);
            });
        }
        else if (this.divIconDirective) {
            this.setIcon(this.divIconDirective);
            this.divIconDirective.updateEvent.subscribe(function (event) {
                _this.setIcon(event.target);
            });
        }
...
MarkerDirective.propDecorators = {
    ...
    'popupDirective': [{ type: core_1.ContentChild, args: [popup_directive_1.PopupDirective,] },],
    'tooltipDirective': [{ type: core_1.ContentChild, args: [tooltip_directive_1.TooltipDirective,] },],
    'iconDirective': [{ type: core_1.ContentChild, args: [icon_directive_1.IconDirective,] },],
    'divIconDirective': [{ type: core_1.ContentChild, args: [div_icon_directive_1.DivIconDirective,] },],
