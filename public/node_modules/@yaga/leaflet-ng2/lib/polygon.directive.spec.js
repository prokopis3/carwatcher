...
describe('Polygon Directive', function () {
    ...
    beforeEach(function () {
        ...
        layer = new index_1.PolygonDirective(map);
    });
    ...
    describe('Popup in Polygon Directive', function () {
        ...
        before(function () {
            ...
            layerWithPopup = Object.create(new index_1.PolygonDirective(map), { popupDirective: { value: popup } });
    ...
    describe('Tooltip in Polygon Directive', function () {
        ...
        before(function () {
            ...
            // Hack to get write-access to readonly property
            layerWithTooltip = Object.create(new index_1.PolygonDirective(map), { tooltipDirective: { value: tooltip } });
